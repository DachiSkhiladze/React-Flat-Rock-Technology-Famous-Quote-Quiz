...
export default function InsertBinaryQuestion() {
...
const send = async () => {
    try{
        ...
        const response = await fetch('https://localhost:7120/CreateQuestion/BinaryQuestions', requestOptions);
        ...
        if (response.status === 200) {
            ...
            window.location = "/QuoteManagement";
            console.log("Dachi");
		}
    }
    catch(err){
